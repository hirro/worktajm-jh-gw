...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "worktajmGw@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "worktajmGw API";

        private String description = "worktajmGw API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "worktajmGw";
